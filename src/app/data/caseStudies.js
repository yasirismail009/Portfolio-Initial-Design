export const caseStudies = [
    ...
    },
    {
      ...
      client: "NextGen Bank",
      duration: "24 months",
      results: ["1M+ Active Users", "99.9% Uptime", "Seamless Integration"],
      content: {
        overview: "NextGen Bank, a forward-thinking financial institution, wanted to create a next-generation banking platform that would revolutionize the way people interact with their finances. They needed a secure, scalable, and user-friendly solution.",
        challenge: "The bank faced several challenges:\n\n• Outdated legacy systems limiting innovation\n• Poor user experience on existing platforms\n• Security concerns with current infrastructure\n• Limited integration capabilities\n• High maintenance costs",
        solution: "We built a comprehensive financial platform:\n\n• Developed a microservices-based architecture\n• Implemented advanced security protocols\n• Created an intuitive mobile-first interface\n• Built real-time transaction processing\n• Integrated with multiple payment systems\n• Developed AI-powered financial insights",
        results: "The platform achieved outstanding results:\n\n• Over 1 million active users in the first year\n• 99.9% system uptime\n• 60% reduction in transaction processing time\n• 40% increase in customer engagement\n• 50% reduction in operational costs\n• Enhanced security with zero major breaches",
        technologies: ["Java", "Spring Boot", "React Native", "Kafka", "MongoDB", "AWS"],
        testimonial: {
          quote: "The new platform has completely transformed our banking operations. We've seen unprecedented growth in user adoption and customer satisfaction while maintaining the highest security standards.",
          author: "David Wilson",
          position: "CEO, NextGen Bank"
        }
      }
    },
    {
